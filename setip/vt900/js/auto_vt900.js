...
//http://www.thaiwebsms.com/vip/api_zsrt.php
function open_wite() {
    $('#loading').show();
}
...
function send_auto() {
    open_wite();
    setTimeout(set_ip, 0);
    setTimeout(set_acc, 5000);
    setTimeout(set_alarm, 10000);
    setTimeout(set_turn, 15000);
    setTimeout(set_rfid, 20000);
    setTimeout(set_gmt, 25000);
    setTimeout(set_tcp, 30000);
    setTimeout(set_timer, 35000);
    setTimeout(set_speedAlarm, 40000);
    setTimeout(set_sim, 45000);
    setTimeout(alertShow, 45000);
    setTimeout(close_wite, 44999);
}
