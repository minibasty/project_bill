    ...
    $getSimno = isset($_GET['number']) ? $_GET['number'] : '';
     ...
     <div class="container">
      <!-- <form class="" action="" method="post"> -->
        ...
        <div class="card-body" id="ipauto" style="display:none">
          ...
          <div class="row">
            <div class="form-group col-sm-12">
              ...
              <input id="svStr<?= $i ?>" type="text" name="" value="<?= $select_ip_row['set_msg_gt06'] ?>" hidden>
          ...
          <div class="form-row">
              <?php
              $select_command_auto="SELECT * FROM setcommand WHERE setcom_model='gt06' AND setcom_auto='1' ORDER BY setcom_que";
              ...
              ?>
                ...
                <input id="commandAuto<?= $iAuto ?>" type="text" name="" value="<?= $select_command_auto_row['setcom_msg'] ?>">
                </div>
        ...
        <div id="ipmanual" class="card-body" style="display:none">
          <div class="form-row">
              <?php
                $i3 = 0;
              ...
              ?>
                <div class="form-group col-sm-12 col-md-6">
                  <input id="ip<?= $i3 ?>" type="text" name="" value="<?= $select_ip_row_manual['set_msg_gt06'] ?>" hidden>
          ...
          <div class="form-row">
            <?php
            $select_command="SELECT * FROM setcommand WHERE setcom_model='gt06' ORDER BY setcom_que";
...
<script src="setip/gt06/js/auto_gt06.js" charset="utf-8"></script>
<script src="setip/gt06/js/manual_gt06.js" charset="utf-8"></script>
  </body>
</html>
