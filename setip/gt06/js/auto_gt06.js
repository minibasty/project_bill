    ...
    function send_auto() {
        ...
        setTimeout(set_ip, 0);
        setTimeout(set_open, 5000);
        setTimeout(set_acc, 10000);
        setTimeout(set_alarm, 15000);
        setTimeout(set_turn, 20000);
        setTimeout(set_rfid, 25000);
        setTimeout(set_gmt, 30000);
        setTimeout(set_tcp, 35000);
        setTimeout(set_timer, 40000);
        setTimeout(set_speedAlarm, 45000);
        setTimeout(set_sim, 50000);
        setTimeout(alertShow, 50000);
        // ปิด Loading
        setTimeout(close_wite, 49999);
    ...
    function clickbtn(id) {
        ...
        msgcommand0 = document.getElementById('commandAuto1').value;
        msgcommand1 = document.getElementById('commandAuto2').value;
        msgcommand2 = document.getElementById('commandAuto3').value;
        msgcommand3 = document.getElementById('commandAuto4').value;
        msgcommand4 = document.getElementById('commandAuto5').value;
        msgcommand5 = document.getElementById('commandAuto6').value;
        msgcommand6 = document.getElementById('commandAuto7').value;
        msgcommand7 = document.getElementById('commandAuto8').value;
        msgcommand8 = document.getElementById('commandAuto9').value;
