      ...
      <!-- <form class="" action="" method="post"> -->
        ...
        <div class="card-body" id="ipauto" style="display:none">
          ...
          <div class="row">
            <div class="form-group col-sm-12">
              ...
              <input id="svStr<?= $i ?>" type="text" name="" value="<?= $select_ip_row['set_msg_vt900u'] ?>" hidden>
          ...
          <div class="form-row">
              <?php
              $select_command_auto="SELECT * FROM setcommand WHERE setcom_model='vt900u' AND setcom_auto='1' ORDER BY setcom_que";
        ...
        <div id="ipmanual" class="card-body" style="display:none">
          <div class="form-row">
              ...
              ?>
                <div class="form-group col-sm-12 col-md-6">
                  <input id="ip<?= $i3 ?>" type="text" name="" value="<?= $select_ip_row_manual['set_msg_vt900u'] ?>" hidden>
          ...
          <div class="form-row">
            <?php
            $select_command="SELECT * FROM setcommand WHERE setcom_model='vt900u'  ORDER BY setcom_que";
...
<script src="setip/vt900u/js/auto_vt900u.js" charset="utf-8"></script>
<script src="setip/vt900u/js/manual_vt900u.js" charset="utf-8"></script>
