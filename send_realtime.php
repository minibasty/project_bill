...
<head>
      ...
      <div class="card">
        ...
        <div class="offset-4" style="margin-top: 20px ">
          <div class="custom-control custom-checkbox">
            <input type="checkbox" id="customcheckbox1" name="dlt" value="1" class="custom-control-input"
            <?php if ($row_select['connect']=="1") { echo "checked"; }?> >
            <label class="custom-control-label" for="customcheckbox1">ส่งข้อมูลขนส่ง
            <img src="img/connect/dlt.jpg" width="30px" alt="">
            </label>
          </div>
          <div class="custom-control custom-checkbox">
            <input type="checkbox" id="customcheckbox2" name="post" value="1" class="custom-control-input"
            <?php if ($row_select['connect_post']=="1") { echo "checked"; }?> >
            <label class="custom-control-label" for="customcheckbox2">ส่งข้อมูลไปรษณีย์
              <img src="img/connect/post.jpg" width="30px" alt="">
            </label>
          </div>
          <div class="custom-control custom-checkbox">
            <input type="checkbox" id="customcheckbox3" name="acc" value="1" class="custom-control-input"
            <?php if ($row_select['connect_acc']=="1") { echo "checked"; }?> >
  ...
  <?php if($row['gpsmodel1']=="T333"){ $modelInput="1"; }
  ...
  elseif($row['gpsmodel1']=="Fm11"){ $modelInput="6"; }
  elseif($row['gpsmodel1']=="TK103"){ $modelInput="7"; }
   ?>
