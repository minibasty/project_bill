...
<table class="table-sm" border="0" cellpadding="0" cellspacing="0" style="width:100%">
  <tr>
    <td colspan="" style="width: 65%"><img src="../../img/logo.jpg" width="30%" height="10%"></td>
...
<table style="margin-top:10px" border="0"   cellpadding="0" cellspacing="0">
  ...
  <tr>
    <th align="left" colspan="6">ธนาคารกสิกรไทย จำกัด(มหาชน) เลขที่ &nbsp;&nbsp; 4142392785 &nbsp;&nbsp; วันที่ &nbsp;&nbsp; '.date("d/m/Y", strtotime($result_inv['inv_date'])).' &nbsp;&nbsp; จำนวนเงิน &nbsp;&nbsp; '.$totalPayStr.'</th>
   </tr>
  <tr>
