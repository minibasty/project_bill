...
echo "================================================================================================================ <br></p>";
echo ' <a href="add_member_tech.php"> <button type="button" class="btn btn-warning" name="button">กลับ</button></a>';
exit() ;
}
...
work,user,email,uid,car_approve_id,register_type,province2,signup,sim,simno,member_id,age,stamp_staff,sex)
        values('$name','$date','$year','$address','$amper','$zipcode',
        '$phone','$education','$work','$user_name','$email','$uid','$car_approve_id',
        '$register_type','$province2','$signup','$sim','$simno','$member_id','$age','$login','$sex')";
