 ...
 */
(function(c, j) {
    function k(a) { return !c(a).parents().andSelf().filter(function() { return c.curCSS(this, "visibility") === "hidden" || c.expr.filters.hidden(this) }).length }
    c.ui = c.ui || {};
    if (!c.ui.version) {
        c.extend(c.ui, {
            version: "1.8.10",
...
(function(d, I) {
    ...
    d.extend(L.prototype, {
        ...
        setDefaults: function(a) { F(this._defaults, a || {}); return this },
        ...
        _doKeyPress: function(a) {
            ...
            if (d.datepicker._get(b, "constrainInput")) { b = d.datepicker._possibleChars(d.datepicker._get(b, "dateFormat")); var c = String.fromCharCode(a.charCode == I ? a.keyCode : a.charCode); return a.ctrlKey || a.metaKey || c < " " || !b || b.indexOf(c) > -1 }
        },
        _doKeyUp: function(a) {
        ...
        _selectDate: function(a, b) {
            ...
            if (e) e.apply(c.input ? c.input[0] : null, [b, c]);
            ...
            for (var h = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort, i = (c ? c.dayNames : null) || this._defaults.dayNames, g = (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort, m = (c ? c.monthNames : null) || this._defaults.monthNames, q = c = -1, k = -1, l = -1, o = false, n = function(p) {
                    ...
                    j = function(p) {
                        ...
                        for (w = 0; w < p.length; w++)
                            if (b.substr(x, p[w].length).toLowerCase() == p[w].toLowerCase()) { x += p[w].length; return w + 1 }
        ...
        formatDate: function(a, b, c, e) {
            ...
            var g = function(n) {
                ...
                m = function(n, j, r) {
                    j = "" + j;
                    if (g(n))
                        for (; j.length < r;) j = "0" + j;
                    return j
                },
                q = function(n,
                    j, r, u) { return g(n) ? u[j] : r[j] },
                k = "",
                l = false;
            if (b)
                for (var o = 0; o < a.length; o++)
                    if (l)
                        if (a.charAt(o) == "'" && !g("'")) l = false;
                        else k += a.charAt(o);
        ...
        _get: function(a, b) { return a.settings[b] !== I ? a.settings[b] : this._defaults[b] },
        _setDateFromField: function(a, b) {
            if (a.input.val() != a.lastVal) {
                ...
                try { f = this.parseDate(c, e, i, this._yearOffset(a)) || h } catch (g) {
                    this.log(g);
                    e = b ? "" : e
                }
        ...
        _determineDate: function(a, b, c) {
            var e = function(h) {
                ...
                f = function(h) {
                    try { return d.datepicker.parseDate(d.datepicker._get(a, "dateFormat"), h, d.datepicker._getFormatConfig(a), d.datepicker._yearOffset(a)) } catch (i) {}
                    var g =
        ...
        _yearOffset: function(a) { if (this._get(a, "isBuddhist")) return 543; return 0 },
        ...
        _generateHTML: function(a) {
            ...
            var u = this._get(a, "dayNamesMin"),
                x = this._get(a, "monthNames"),
                A = this._get(a, "monthNamesShort"),
            ...
            for (var G = this._getDefaultDate(a), J = "", D = 0; D < i[0]; D++) {
                for (var M = "", E = 0; E < i[1]; E++) {
                    var N = this._daylightSavingAdjust(new Date(n, g, a.selectedDay)),
                        t = " ui-corner-all",
                        y = "";
                    if (q) {
                    ...
                    for (var O = 0; O < B; O++) {
                        ...
                        var P = !m ? "" : '<td class="ui-datepicker-week-col">' + this._get(a, "calculateWeek")(s) +
                            "</td>";
                        for (t = 0; t < 7; t++) {
                            var H = v ? v.apply(a.input ? a.input[0] : null, [s]) : [true, ""],
                                C = s.getMonth() != g,
        ...
        _generateMonthYearHeader: function(a, b, c, e, f, h, i, g) {
            var m = this._get(a, "changeMonth"),
                q = this._get(a, "changeYear"),
                k = this._get(a, "showMonthAfterYear"),
                l = '<div class="ui-datepicker-title">',
                o = "";
            if (h || !m) o += '<span class="ui-datepicker-month">' + i[b] + "</span>";
            else {
                i = e && e.getFullYear() == c;
                ...
                for (var j = 0; j < 12; j++)
                    if ((!i || j >= e.getMonth()) && (!n || j <= f.getMonth())) o += '<option value="' + j + '"' + (j == b ? ' selected="selected"' : "") + ">" + g[j] + "</option>";
                o += "</select>"
            }
            k || (l += o + (h || !(m && q) ? "\u00a0" : ""));
            a.yearshtml = "";
            if (h || !q) l += '<span class="ui-datepicker-year">' + (c + this._yearOffset(a)) + "</span>";
            else {
                g = this._get(a, "yearRange").split(":");
                var r = (new Date).getFullYear();
                i = function(u) { u = u.match(/c[+-].*/) ? c + parseInt(u.substring(1), 10) : u.match(/[+-].*/) ? r + parseInt(u, 10) : parseInt(u, 10); return isNaN(u) ? r : u };
                b = i(g[0]);
                g = Math.max(b, i(g[1] || ""));
                ...
                a.yearshtml += "</select>";
                if (d.browser.mozilla) l += '<select class="ui-datepicker-year"><option value="' + c + '" selected="selected">' + c + "</option></select>";
                else {
                    l += a.yearshtml;
                    a.yearshtml = null
                }
        ...
        _notifyChange: function(a) { var b = this._get(a, "onChangeMonthYear"); if (b) b.apply(a.input ? a.input[0] : null, [a.selectedYear, a.selectedMonth + 1, a]) },
