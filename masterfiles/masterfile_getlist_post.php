...
<body>
   ...
   function delPost($unit){
	...
	$url = 'http://122.155.167.137:3000/masterfile/getList/0/1000';
	$login="mirada.thp";
 		...
 		<div class="card">
          ...
          <form action="" method="post">
	 			<table class="display" id="table_id" width="100%">
					...
					<?php 
						$i=0; 
					 	foreach($data_decode['results'] as $data){ $i++;
...
if(isset($_POST['del'])){
   print_r(delPost($_POST['del']));
   // echo "Delete Me".$_POST['del'];
}
